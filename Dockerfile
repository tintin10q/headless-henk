...
RUN apt-get update && \
    ...
    libharfbuzz-dev libfribidi-dev libxcb1-dev python3-dev build-essential --no-install-recommends && rm -rf /var/lib/apt/lists/* &&\
        pip install --no-cache-dir -r requirements.txt  && \
        apt-get purge -y libfreetype6-dev liblcms2-dev libwebp-dev tcl8.6-dev tk8.6-dev python3-tk \
    libharfbuzz-dev libfribidi-dev libxcb1-dev python3-dev build-essential && \
